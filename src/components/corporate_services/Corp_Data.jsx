...
import corpData from '../../data/corp.json';
            ...
            <div className="container px-4 mx-auto lg:px-12">
                <div className='pb-2'>
                    ...
                    <h2 class="relative mb-4  text-2xl font-semibold tracking-wide text-center text-orange-500 font-oxygen">
                        <span class="inline-block p-2">VARIOUS CORPORATE SERVICES</span>
                ...
                <div className="grid grid-cols-1 gap-8 text-[14px] p-4 md:grid-cols-3">
                    {corpData.map((service, index) => (
                        <div
                            key={service.id}
