...
//                     People.<span className="text-gray-700"> Process.</span> <span className="text-gray-700">Passion.</span>
...
//                 <button onClick={toggleExpand} className="flex items-center block my-4 text-xl font-semibold text-orange-500">
//                     <span className="mr-2 text-4xl">{isExpanded ? '+' : '^'}</span>
