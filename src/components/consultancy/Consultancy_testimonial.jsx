...
const Consultancy_testimonial = () => {
    ...
    return (
        <section className="py-4 mt-10 bg-white">
            <div className="container px-4 mx-auto lg:px-12">
                <div className="mb-12 text-center">
                    ...
                    <h2 class="relative mb-4  text-2xl font-semibold tracking-wide text-center text-orange-500 font-oxygen">
                        <span class="inline-block p-2">What do our clients say about us?</span>
...
export default Consultancy_testimonial
