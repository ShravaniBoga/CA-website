...
const Consultancy_key = () => {
    return (
        <div>
            <div className="flex flex-col overflow-hidden bg-white rounded-lg shadow-lg md:flex-row bg-gradient-to-r from-[#f3f3f7] via-[#535456] via-[#535456] to-[#838384]">
                <div className="mr-12 md:w-1/2">
                    <img
                        src="./assets/cons-key.png"
                        alt="Auditor"
...
export default Consultancy_key 
